...
export function FeedbackSuccessStep({ onRestartFeedback }: FeedbackSuccessStepProps) {
    return(
        ...
        onClick={onRestartFeedback}
            className="px-6 py-2 mt-6 text-sm leading-6 transition-colors border-transparent bg-zinc-800 rounden-md hover:bg-zinc-700 focus:bg-zinc-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-brand-500" 
        >
